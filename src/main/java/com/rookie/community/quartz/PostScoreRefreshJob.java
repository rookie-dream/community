package com.rookie.community.quartz;
...
public class PostScoreRefreshJob implements Job, CommunityConstant {
    ...
    static {
        try {
            EPOCH = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse("2022-02-01 00:00:00");
        } catch (ParseException e) {
            throw new RuntimeException("初始化菜鸟纪元失败！", e);
        }
    }
    ...
    private void refresh(int postId) {
        ...
        //计算  分数 = log( 加精 + 评论数 * 10 + 点赞 * 2 ） + （发布时间 - 网站创建时间）
        //计算权重
